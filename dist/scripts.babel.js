      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            contentPromise = makeRequest('GET', 'https://us-central1-open-classrooms-js-for-the-web.cloudfunctions.net/widgets/generate-lorem'); // await responses from three requests and assign to three constants
          ...
          case 5:
            ...
            contentResponse = _ref3[2]; // concatenate data from GET requests and make POST request

            postPromise = makeRequest('POST', 'https://us-central1-open-classrooms-js-for-the-web.cloudfunctions.net/widgets/create-post-with-uid', {
              uid: uidResponse.uid,
